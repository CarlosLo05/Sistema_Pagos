...
$address = mysqli_real_escape_string($conn,$_POST['address']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (branch,address) VALUES ('$branch','$address')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  branch  SET  branch  = '$branch', address  = '$address' WHERE  id  = '$id'");
...
{
$errormsg = "<div class='alert alert-success'><strong>Súper!!!</strong> Año agregado exitósamente</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><strong>Súper!!!</strong> Información de Año editada exitósamente</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><strong>Súper!!!</strong> Información de Año eliminada exitósamente</div>";
}
            ...
            <span class="stickers">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img class="año" src="img/material-escolar.png" alt="año">
                             Año Del Estudiante
                        </h1>
                     <?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="branch.php" class="btn btn-primary btn-sn pull-right">Volver <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="branch.php?action=add" class="btn btn-primary btn-sn pull-right"><i class="glyphicon glyphicon-plus"></i> Agregar Año </a>';
						?>
<?php
...
?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Agregar Año": "Editar Año"; ?>
                        </div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Año Del Estudiante </label>
								<div class="col-sm-10">
									<input type="text" class="form-label" id="branch" name="branch" value="<?php echo $branch;?>"  />
								</div>
							</div>
							

							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password"> Año Lectivo </label>
								<div class="col-sm-10">
	                        <textarea class="form-label" id="address" name="address"><?php echo $address;?></textarea >
								</div>
							</div>
		...
		$( document ).ready( function () {			
			 ...
			 if($("#signupForm1").length > 0)
         {
			$( "#signupForm1" ).validate( {
				...
				messages: {
					branch: "Por favor Ingrese Año Del Estudiante",
					address:"Por Favor Ingrese Año Lectivo"	
		...
		<div class="panel panel-default">
                        <div class="panel-heading">
                            Administrar Información de los Años  
                        </div>
                        <div class="panel-body">
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									?>
									<!-- enla linea echo de arriba existe la opcion de habilitar la edicion y la opcion de borrar agregar un <td>-->
                               <!-- <a href="branch.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
											
								<a onclick="return confirm(\'Realmente deseas continuar. Si confirmas el registro se eliminará de manera irreversible\');" href="branch.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></a> -->
