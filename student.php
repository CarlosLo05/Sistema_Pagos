		...
		?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Cedula* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="contact" pattern="[0-9]{12}" name="contact" value="<?php echo $contact;?>" maxlength="12" />
								</div>
							</div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">A Pagar </label>
								<div class="col-sm-10">
